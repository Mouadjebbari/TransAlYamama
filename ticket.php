                                    ...
                                    if($row_f = mysqli_fetch_assoc($result_f)) {
                                        ...
                                        <div class="col-8 out">
                                            ...
                                            <div class="row" >
                                                ...
                                                &nbsp 
                                                Veuillez être à la porte à l heure du bus</h3>   
                                            </div>                   
                                        </div>
                                        ...
                                        <div class="col-3 pl-0" style="background-color:black !important;
                                            ...
                                            <div class="row">
                                                <h3 class="text-light2 text-center mt-2 mb-0">
                                                &nbsp Merci de nous avoir choisi. 
                                                    </h3>   
                                            </div>                            
                                        </div>   
                                                ...
                                                <div class="dropdown-menu">
                                                    <form class="px-4 py-3"  action="ticket.php" 
                                                        ...
                                                        <input type="hidden" name="ticket_id" 
                                                            value='.$row['ticket_id'].'>
                                                            <button class="btn btn-danger btn-sm" name="cancel_but" style="background-color: red; border-color: red;">
                                                            <i class="fa fa-trash"></i> &nbsp; Annuler le billet
                                                        </button>
                                                    </form>
                                                    <form class="px-4 py-3" action="e_ticket.php" target="_blank"
                                                        ...
                                                        <button class="btn w-100 mb-3 btn-primary btn-sm"
                                                            name="print_but">
                                                            <i class="fa fa-print"></i> &nbsp; Imprimer le billet</button>
                                                    </form>                                    
                                                </div>
                                            </div>              
                                        </div>                          
