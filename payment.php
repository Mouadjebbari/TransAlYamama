...
<?php
  if(isset($_GET['error'])) {
    if($_GET['error'] === 'sqlerror') {
      ...
      echo"<script>alert('No return bus available')</script>";
...
<section class="inner-banner bg_img" style="background: url(assets/images/frontend/breadcrumb/61f14e10b48871643204112.jpg) center">
    <div class="container">
        <div class="inner-banner-content">
            <h2 class="title">PAYER SA COMMANDE</h2>
        </div>
    </div>
</section><br><br>
    ...
    <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-4 mx-auto">
          <!-- <h1 class="text-center">PAYER SA COMMANDE</h1> -->
            ...
            <div class="icon-container">
              ...
              <i class="fab fa-cc-discover fa-3x" style="color:orange;"></i>
               <i class="fab fa-cc-stripe fa-3x" style="color:blue;"></i>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <span class="invalid-feedback">Saisissez la date de péremption</span>
                        </div>
                    </div>
                    <div class="col-6 p-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col pr-0">                            
                                <span class="invalid-feedback order-last">Entrez le code à 3 chiffres au dos</span>
                                <div class="input-group-append">
                                    <div class="input-group-text">
                                    <span class="fa fa-question-circle fa-lg" data-toggle="popover" data-container="body" data-html="true" data-title="CVV" 
                                    data-content="<div class='text-center one-card'>Le code à 3 chiffres au dos de la carte..<div class='visa-mc-cvc-preview'></div></div>"
